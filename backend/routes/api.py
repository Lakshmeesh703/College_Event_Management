...
from ..models import Competition, Event, EventParticipation, Participant, db
...
def event_competitions(event_id: int):
    ...
    return jsonify({"event_id": event_id, "count": len(payload), "competitions": payload})
